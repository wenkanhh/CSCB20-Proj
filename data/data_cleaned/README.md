...
5. requirements_groups.csv - groups individual prerequisite or corequisite conditions together into logical blocks, one group represents one logical chunk of a requirement:
...
- delivery: how the course LEC was delivered, one of In-person, Online, or Hybrid
- day_time: the scheduled days for this offering LEC if available
